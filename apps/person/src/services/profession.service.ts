...
import {Profession, ProfessionCreateDto, ProfessionUpdateDto} from "@app/common";
...
export class ProfessionService {
    ...
    async createProfession(createProfessionDto: ProfessionCreateDto) {
    ...
    async editProfession(updateProfessionDto: ProfessionUpdateDto, id: number) {
