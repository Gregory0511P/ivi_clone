...
export class AdminService {
    ...
    async addRelatedFilm(id: number, addRelatedFilmDto: RelatedFilmAddDto) {
    ...
    async addGenre(filmId: number, addGenreDto: GenreAddDto) {
        const film = await this.filmService.getFilmById(filmId);
    ...
    async addCountry(filmId: number, addCountryDto: CountryAddDto) {
        const film = await this.filmService.getFilmById(filmId);
    ...
    async addAward(filmId: number, addAwardDto: AwardAddDto) {
        const film = await this.filmService.getFilmById(filmId);
