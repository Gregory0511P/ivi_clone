...
import {Genre, FilmGenres, GenreCreateDto, genresMap, GenreUpdateDto} from "@app/common";
...
export class GenreService {
    ...
    async createGenre(createGenreDto: GenreCreateDto) {
    ...
    async getOrCreateGenre(createGenreDto: GenreCreateDto) {
    ...
    async editGenre(updateGenreDto: GenreUpdateDto, id: number) {
        try {
    ...
    async addGenreInMap(createGenreDto: GenreCreateDto) {
