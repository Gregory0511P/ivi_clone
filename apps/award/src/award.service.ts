...
import {Award, AwardCreateDto, NominationCreateDto, Film, FilmAwards, Nomination, AwardUpdateDto} from "@app/common";
...
export class AwardService {
    ...
    async createAward(createAwardDto: AwardCreateDto) {
    ...
    async getOrCreateAward(createAwardDto: AwardCreateDto) {
    ...
    async editAward(updateAwardDto: AwardUpdateDto, id: number) {
    ...
    async createNomination(createNominationDto: NominationCreateDto) {
        return await this.nominationRepository.create(createNominationDto);
    }

    async getOrCreateNomination(dto: NominationCreateDto) {
    ...
    async editNomination(createNominationDto: NominationCreateDto, id: number) {
