...
import {RoleAddDto, RegistrationDto, Review, UserUpdateDto, User, UserRoles} from "@app/common";
...
export class UserService {
    ...
    async updateUser(updateUserDto: UserUpdateDto, id, hash = true) {
    ...
    async addRoleToUser(addRoleDto: RoleAddDto) {
    ...
    async deleteRoleFromUser(addRoleDto: RoleAddDto) {
        const role = await lastValueFrom(this.roleClient.send({
            cmd: "get-role-by-value"
        }, {
            value: addRoleDto.value
